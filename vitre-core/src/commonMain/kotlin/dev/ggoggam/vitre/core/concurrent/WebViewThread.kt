 ...
 * wrapped by [WebViewSerializer], and it is the only thing in the library that references this
 * dispatcher. Business logic and workflow evaluation stay on whatever dispatcher their caller
 * chose (`Dispatchers.Default` for the engine) and cross over one suspending call at a time.
 */
